"""
Intent-Driven Progressive Disclosure Service for SmartDoc

This module integrates the LLM Intent Classifier with Progressive Disclosure,
allowing natural conversation to drive information discovery.
When doctors ask questions, relevant information blocks are automatically discovered and revealed.
"""
...
from smartdoc.services.progressive_disclosure import ProgressiveDisclosureManager, InformationBlock
