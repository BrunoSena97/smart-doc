...
class LLMIntentClassifier:
    ...
    def _default_intent_categories(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "pmh_general": {
                "description": "Questions about past medical history, chronic conditions, diagnoses, or diseases. Does NOT include medications/drugs/pills (those are 'meds_current_known'). Focus on diseases, conditions, and diagnoses.",
                "examples": [
                    "Past medical history?",
                    "Tell me about her past medical history",
            ...
            "meds_current_known": {
                "description": "Questions SPECIFICALLY about current medications, drugs, pills, or prescriptions. Must mention 'medication', 'drug', 'pill', 'prescription', or 'medicine' explicitly. NOT for medical history, diagnoses, or conditions.",
                "examples": [
