...
[![LLM](https://img.shields.io/badge/LLM-Ollama## 🐳 Production Deployment

SmartDoc includes production-ready deployment for Traefik environments using Docker Compose.

### 🚀 Quick Deployment

```bash
# Production deployment (Traefik integration)
make deploy
...
# Stop everything.svg)](https://ollama.ai)
[![License](https://img.shields.io/badge/License-Academic-orange.svg)](LICENSE)
[![Architecture](https://img.shields.io/badge/Architecture-Monorepo-blue.svg)](https://monorepo.tools)

> A comprehensive master's thesis project featuring advanced AI systems for medical education with professional monorepo architecture, including LLM-powered discovery, cognitive bias detection, and metacognitive assessment.## 🎯 Project Overview
...
- **👥 Virtual Patient Personas**: Realistic patient representation with cultural context## 🏗️ Professional Monorepo Architecture
...
│ ├── 📂 src/smartdoc_api/ # API source code
...
│ │ │ ├── 📂 discovery/ # Discovery processing
...
- **Session Management**: Real-time tracking with bias monitoring and deduplication## 📁 Professional Project Structure
...
│ ├── � core/ # AI and simulation engine
│ └── 📂 shared/ # Common utilities
├── 📂 configs/ # Environment configurations
├── 📂 data/ # Clinical cases and research data
├── � scripts/ # Development automation
├── 📂 deployments/ # Container and deployment configs
├── 📂 docs/ # Comprehensive documentation
├── � tests/ # Integration testing
├── 📂 old_structure/ # Archived legacy code
...
#### � `packages/core` - SmartDoc Core Engine
...
- **Templates**: Jinja2 templates for web interface## 🚀 Getting Started
...
SmartDoc includes production-ready deployment configurations using Docker Compose with Poetry 2.1.4 and Python 3.13.7.
...
2. **Available Commands**:
   ...
   ```bash
   make dev-up      # Development with live reload
...
3. **Health Monitoring**:
   ```bash
   ./deployments/health-check.sh    # Quick health check
   make test-deployment             # Comprehensive tests
   ```

### 🔧 Production Features

- **Gunicorn WSGI server** with optimized worker configuration
- **Nginx reverse proxy** serving static files and API routing
- **Health checks** for container orchestration
- **Persistent SQLite database** with Docker volumes
- **Security headers** and CORS configuration
- **Automatic database migrations** on container startup
- **Environment-aware frontend** (dev vs prod API endpoints)

For detailed deployment documentation, see [`deployments/README.md`](deployments/README.md).
...
**Bruno Sena**
_Master's in Software Engineering_
_Specialization: AI Systems for Medical Education_
_Research Focus: Cognitive Bias Detection in Clinical Reasoning_
...
_This project represents a significant advancement in AI-powered medical education, combining cutting-edge language models with evidence-based educational psychology to create an innovative platform for clinical training and cognitive bias research._
