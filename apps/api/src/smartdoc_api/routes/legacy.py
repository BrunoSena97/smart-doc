...
try:
    ...
    def start_new_session():
        ...
        class MockSession:
            ...
            def log_interaction(self, **kwargs): self.interactions.append(kwargs)
            def get_interactions(self): return self.interactions
            def get_bias_summary(self): return {"bias_warnings": []}
            def get_latest_bias_warning(self): return None
...
def serve_static(filename):
    ...
    static_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'web', 'public')
